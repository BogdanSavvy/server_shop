...
if (catalogColumnsButtons || catalogGridContent) {
...
if (stepPlusButton || stepMinusButton) {
...
if (colorSelectButtons || cardSliders) {
	colorSelectButtons.forEach(button => {
		button.addEventListener('click', e => {
			let hasActiveClass = button.classList.contains(
				'color-select__btn--active',
			);
